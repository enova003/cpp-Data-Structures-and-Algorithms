...
public:
  ...
  typedef std::list<Term>::iterator iterator;
  typedef std::list<Term>::const_iterator const_iterator;
   ...
   */
  Polynomial (std::initializer_list<Term> term2);
  ...
  // Appropriate functions to return the beginning and ending of the iterators:
  iterator begin();
  iterator end();
